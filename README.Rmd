...
* `kinshipX()` : Computes the X chromosomal kinship matrix (available soon)
   
* `kappa()` : Computes the IBD (kappa) coefficients of two non-inbred pedigree members
* `kappaX()` : Computes the X chromosomal IBD coefficients of two non-inbred pedigree members (available soon)
